...
class ApiRestController {
    ...
    /**
     * Devuelve template json para el caso en que el servicio
     * llamado no esté implementado
     * 
     * @return array template, values
     */
    public function IndexAction() {

        $this->values['json'] = array(
            'status' => 400,
            'statusMessage' => 'Service not implemented',
            'result' => array(),
        );
    ...
    public function HistoricoComprasAction() {
        ...
        $values['datos'] = array(
            ...
            'articulo' => $articulo->iterator(),
            'proveedor' => $proveedor->iterator(),
            'unidades' => $unidades,
            'periodo' => $periodo,
            'periodos' => $periodos,
        ...
        if (in_array($formato, $this->formats)) {
            ...
            $this->values['json'] = array(
                'status' => 401,
                'statusMessage' => 'Format not implemented',
                'result' => array(),
            );
            $template = "_global/json.twig";
        }
