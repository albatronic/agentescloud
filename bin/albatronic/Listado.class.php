...
class Listado {
    ...
    public function getAll($aditionalFilter = '') {
        ...
        return array(
            ...
            'export_types' => ($this->form->getNode('export')) ? $_SESSION['export_types'] : array(),
        );
    }
    ...
    public function getXml($idFormatoListado, $aditionalFilter = '') {
        ...
        $archivo = "docs/docs" . $_SESSION['emp'] . "/export/" . md5(date('d-m-Y H:i:s')) . ".xml";
        $fp = @fopen($archivo, "w");
        if ($fp) {
            fwrite($fp, $xmlString);
            fclose($fp);
    ...
    /**
     * Genera un archivo JSON con el listado
     * @param integer $idFormatoListado
     * @param string $aditionalFilter
     * @return string $archivo El nombre completo (con la ruta) del archivo xml generado
     */
    public function getJson($idFormatoListado, $aditionalFilter = '') {
        set_time_limit(0);
        ...
        $jsonString = json_encode($arrayYml);

        $archivo = "docs/docs" . $_SESSION['emp'] . "/export/" . md5(date('d-m-Y H:i:s')) . ".json";
    ...
    public function getYaml($idFormatoListado, $aditionalFilter = '') {
        ...
        $archivo = "docs/docs" . $_SESSION['emp'] . "/export/" . md5(date('d-m-Y H:i:s')) . ".yml";
        $fp = @fopen($archivo, "w");
        if ($fp) {
    ...
    public function getCsv($idFormatoListado, $aditionalFilter = '') {
        ...
        $archivo = "docs/docs" . $_SESSION['emp'] . "/export/" . md5(date('d-m-Y H:i:s')) . ".csv";
